...
urlpatterns = [
    ...
    path('api/books/share-comment/',views.PostComment.as_view()),
    ...
    path('api/books/rate-book/',views.PostRating.as_view()),
    path('api/books/<int:user_id>/bio/',views.ViewUserBio.as_view()),
    path('api/books/add-bio/',views.UserBio.as_view()),
