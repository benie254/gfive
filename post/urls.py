...
urlpatterns = [
    ...
    path('api/books/<int:book_id>/comments/',views.Comments.as_view()),
    path('api/books/comment-book/',views.AddComment.as_view()),
    ...
    path('api/user/add-profile/',views.AddProfile.as_view()),
