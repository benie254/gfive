...
from post.serializer import BookSerializer,RatingSerializer,CommentSerializer,CategorySerializer
from post.models import Book,Rating,Comment,Category  
from rest_framework import status
from .permissions import IsAdminOrReadOnly

# Create your views here.
class OurBookCategories(APIView):
